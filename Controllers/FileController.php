...
class FileController
{
    ...
    /**
     * В SESSION['initialPath'] храниться информация о пути к корневой папке пользователея
     * Если сессия существует и имеется папка по указанному пути, то создается объект класса
     * если нет, то возвращается ошибка 401 и записывается сообщение в лог файл
     * @param $db
     * @throws Exception
     */
